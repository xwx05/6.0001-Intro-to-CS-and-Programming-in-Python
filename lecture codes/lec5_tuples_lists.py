...
colors1.append(warm)
print('colors1 = ', colors1)  # colors1 =  [['blue', 'green'], ['red', 'yellow', 'orange']]

colors2 = [['blue', 'green'],
           ['red', 'yellow', 'orange']]
print('colors2 =', colors2)
#
warm.remove('red')  # warm已经被修改了
print('colors1 = ', colors1)  # colors1 中有warm, 受到影响
print('colors2 =', colors2)  # colors2 中没有warm, 不受影响
#
# for e in colors1:
#     print('e =', e)
#
